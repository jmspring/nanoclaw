...
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/zfs clone zroot/nanoclaw/jails/template@* zroot/nanoclaw/jails/*
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/zfs destroy * zroot/nanoclaw/jails/*
...
# Directory and file operations for jail paths
...
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /usr/bin/tee

# Resource limits
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /usr/bin/rctl
