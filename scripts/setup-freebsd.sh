...
# Jail management
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /usr/sbin/jail
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /usr/sbin/jexec
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /usr/sbin/jls

# ZFS operations (create, clone, destroy, snapshot, list, set, get)
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/zfs

# Mount operations
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/mount
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/mount_nullfs
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/mount_devfs
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/umount

# Network operations (for epair create/destroy in restricted mode)
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/ifconfig
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/route

# Directory operations for jail paths
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /bin/mkdir
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /bin/chmod
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /usr/sbin/chown
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /bin/cp
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /bin/sh
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /bin/cat
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /sbin/sysctl

# Package management inside jails
$NANOCLAW_USER ALL=(ALL) NOPASSWD: /usr/sbin/pkg
EOF
